    ...
    <div className="flex items-center justify-center py-12">
      <div className="w-full max-w-md bg-white border-[3px] border-black rounded-[2rem] p-8 shadow-[8px_8px_0px_0px_#000]">
        <div className="flex justify-center mb-6">
          <div className="bg-[#fde047] p-4 rounded-3xl border-[3px] border-black shadow-[4px_4px_0px_0px_#000]">
            <Sparkles className="w-10 h-10 text-black stroke-[2.5]" />
          </div>
        </div>
        <h1 className="text-3xl font-black text-center text-black mb-2">Create Account</h1>
        <p className="text-center text-zinc-600 font-bold mb-8">Start logging matches to your personal diary.</p>
        ...
        <p className="text-center text-sm font-bold text-zinc-600 mt-6">
          Already have an account? <Link href="/login" className="text-black font-black underline decoration-2 hover:text-[#ec4899]">Log in here</Link>
        </p>
      </div>
    </div>
  )
